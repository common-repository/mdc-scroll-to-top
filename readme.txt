...
Donate link: http://codebanyan.com
Tags: scroll to top, scroll button, top scroll, page scrolling, go to top, page top, go to top of page, wordpress scroll
...
3. Appearance settings allow you to set icon height, width, position, padding etc.
